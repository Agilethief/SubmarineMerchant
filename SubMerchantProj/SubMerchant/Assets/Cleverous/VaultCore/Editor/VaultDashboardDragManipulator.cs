...
{
    public class VaultDashboardDragManipulator : PointerManipulator
    {
        ...
        private VaultDataGroupFoldableButton m_currentHoverTarget;
        private bool m_isPressed;

        public VaultDashboardDragManipulator(VisualElement origin, VisualElement rootWindow)
        {
        ...
        private void PointerMoveHandler(PointerMoveEvent evt)
        {
            ...
            if (hovered is Button 
                && hovered.parent is VaultDataGroupFoldableButton groupbutton 
                && VaultFilterColumnInheritance.CustomGroupsFoldout.Q<VaultDataGroupFoldableButton>(groupbutton.name) != null)
            {
        ...
        private void PointerUpHandler(PointerUpEvent evt)
        {
            ...
            {
                m_currentHoverTarget.DataGroup.AddEntity(VaultDashboard.CurrentSelectedAsset);
            }
