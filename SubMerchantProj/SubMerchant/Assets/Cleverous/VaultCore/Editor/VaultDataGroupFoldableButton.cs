...
{
    public class VaultDataGroupFoldableButton : VisualElement, IVaultDataGroupButton
    {
        public static VaultDataGroupFoldableButton CurrentSelected;
        ...
        public VaultDataGroupFoldableButton(IDataGroup group, Texture icon, bool isCustomGroup)
        {
            name = group.Title;
        ...
        public virtual void SetAsCurrent()
        {
            ...
            VaultDashboard.Instance.SetCurrentGroup(DataGroup);
        }
    }
}